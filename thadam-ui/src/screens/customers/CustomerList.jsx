        ...
        <Paper elevation={3}>
          <div className='header'>
            ...
            <span className='btn-row'>
              <Button variant="contained" className='btn header-btn' sx={{ background: '#04B900' }} onClick={() => addCustomer()}>
          ...
          <div className='body'>
            ...
            <div>
              <Paper sx={{ mt: 2, width: '100%', overflow: 'hidden' }} elevation={3}>
                <TableList columns={customerTableColumns} data={customerList} onEdit={editCustomer} onDelete={deleteCustomerConfirm} />
              </Paper>
            </div>
            <div>
